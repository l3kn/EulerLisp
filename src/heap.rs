...
impl<T: Default> Arena<T> {
    ...
    pub fn allocate(&mut self) -> (HeapPairRef, &mut T) {
...
impl Heap {
    ...
    pub fn allocate_pair(&mut self) -> (HeapPairRef, &mut Pair) {
        self.pair_arena.allocate()
    }

    pub fn get_pair(&self, idx: HeapPairRef) -> &Pair {
        self.pair_arena.get(idx)
    }

    pub fn get_pair_mut(&mut self, idx: HeapPairRef) -> &mut Pair {
    ...
    pub fn get_pair_list(&self, idx: HeapPairRef) -> LispResult<Vec<Datum>> {
